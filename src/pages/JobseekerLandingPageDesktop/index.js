    ...
    <>
      <Column className="bg-white_A700 font-ubuntu justify-start mx-[auto] w-[100%]">
        <Column className="items-center w-[100%]">
          <Stack className="lg:h-[586px] xl:h-[734px] 2xl:h-[825px] 3xl:h-[990px] w-[100%]">
            <Stack className="absolute lg:h-[586px] xl:h-[734px] 2xl:h-[825px] 3xl:h-[990px] inset-[0] w-[100%]">
              <Img
                src="images/img_maskgroup.png"
                className="absolute lg:h-[586px] xl:h-[734px] 2xl:h-[825px] 3xl:h-[990px] inset-[0] w-[100%]"
                alt="MaskGroup"
              />
                ...
                <Row className="items-center justify-between w-[100%]">
                  <Row className="items-center justify-center xl:ml-[106px] 2xl:ml-[120px] 3xl:ml-[144px] lg:ml-[85px] w-[37%]">
                    <Row className="items-center w-[20%]">
                      ...
                      />
                      <Text
                        className="font-bold lg:ml-[4px] xl:ml-[5px] 2xl:ml-[6px] 3xl:ml-[7px] text-amber_300 w-[auto]"
                        variant="body1"
                      >
                        <span className="text-white_A700 font-sora lg:text-[14px] xl:text-[17px] 2xl:text-[20px] 3xl:text-[24px]">
                          Jbs
                        </span>
                        <span className="text-amber_300 font-sora lg:text-[14px] xl:text-[17px] 2xl:text-[20px] 3xl:text-[24px]">
                          .me
                        </span>
                      </Text>
                    </Row>
                    <Row className="font-sora items-center justify-between lg:ml-[45px] xl:ml-[56px] 2xl:ml-[64px] 3xl:ml-[76px] w-[68%]">
                      <Text
                        className="cursor-pointer hover:font-semibold font-semibold text-amber_300 w-[auto]"
                        variant="body4"
                      >
                        Home
                      </Text>
                      <Text
                        className="hover:font-semibold hover:text-amber_300 Category"
                        variant="body4"
                      >
                        Category
                      </Text>
                  ...
                  <Row className="font-sora items-center justify-center xl:mr-[106px] 2xl:mr-[120px] 3xl:mr-[144px] lg:mr-[85px] lg:my-[25px] xl:my-[32px] 2xl:my-[36px] 3xl:my-[43px] w-[15%]">
                    <Text
                      className="font-semibold lg:ml-[17px] xl:ml-[21px] 2xl:ml-[24px] 3xl:ml-[28px] text-white_A700 w-[auto]"
                      variant="body4"
                    >
                      Login
                    </Text>
            ...
            <Column className="absolute bottom-[10%] font-sora justify-start left-[8%] w-[43%]">
                ...
                <Column className="justify-start w-[100%]">
                  <Column className="font-sora items-center w-[100%]">
                    <Stack className="lg:h-[131px] xl:h-[164px] 2xl:h-[185px] 3xl:h-[221px] w-[100%]">
                      ...
                      <Text
                        className="absolute inset-[0] 3xl:leading-[110px] lg:leading-[65px] xl:leading-[81px] 2xl:leading-[92px] text-white_A700 lg:tracking-ls2 2xl:tracking-ls3 xl:tracking-ls3 3xl:tracking-ls4 w-[100%]"
                        as="h1"
                        variant="h1"
                      >
                        <span className="text-white_A700 font-sora font-semibold lg:text-[51px] xl:text-[64px] 2xl:text-[72px] 3xl:text-[86px]">
                          The best jobsite
                          <br />
                          for your{" "}
                        </span>
                        <span className="text-bluegray_900 font-sora font-semibold lg:text-[51px] xl:text-[64px] 2xl:text-[72px] 3xl:text-[86px]">
                          future
                        </span>
                      </Text>
                    </Stack>
                  ...
                  <Text
                    className="font-light font-opensans lg:leading-[23px] xl:leading-[29px] 2xl:leading-[33px] 3xl:leading-[39px] lg:mt-[17px] xl:mt-[21px] 2xl:mt-[24px] 3xl:mt-[28px] text-white_A700 w-[100%]"
                    variant="body2"
                  >
              ...
              <Text
                className="font-normal lg:leading-[23px] xl:leading-[29px] 2xl:leading-[33px] 3xl:leading-[39px] lg:mt-[56px] xl:mt-[71px] 2xl:mt-[80px] 3xl:mt-[96px] not-italic text-white_A700_cc w-[34%]"
                variant="body4"
              >
              ...
              <Row className="font-montserrat items-center lg:mt-[17px] xl:mt-[21px] 2xl:mt-[24px] 3xl:mt-[28px] w-[92%]">
                <Row className="items-center w-[18%]">
                  ...
                  />
                  <Text
                    className="font-medium mb-[0.18px] lg:ml-[4px] xl:ml-[5px] 2xl:ml-[6px] 3xl:ml-[7px] text-white_A700_7f w-[auto]"
                    as="h5"
                    variant="h5"
                  >
                    Meta
                ...
                <Row className="font-worksans items-start justify-center lg:ml-[39px] xl:ml-[49px] 2xl:ml-[56px] 3xl:ml-[67px] w-[18%]">
                  <Text
                    className="font-semibold text-white_A700_7f w-[auto]"
                    as="h5"
                    variant="h5"
                  >
                    Linked
          ...
          <Row className="bg-indigo_800 font-sora items-center lg:mt-[29px] xl:mt-[36px] 2xl:mt-[41px] 3xl:mt-[49px] w-[100%]">
            <Column className="lg:ml-[152px] xl:ml-[191px] 2xl:ml-[215px] 3xl:ml-[258px] lg:my-[35px] xl:my-[44px] 2xl:my-[50px] 3xl:my-[60px] w-[11%]">
              <Text
                className="ml-[3px] text-white_A700 w-[auto]"
                as="h2"
                variant="h2"
              >
                <span className="text-white_A700 font-sora font-semibold lg:text-[39px] xl:text-[49px] 2xl:text-[56px] 3xl:text-[67px]">
                  1,9
                </span>
                <span className="text-orange_300 font-sora font-semibold lg:text-[39px] xl:text-[49px] 2xl:text-[56px] 3xl:text-[67px]">
                  K+
                </span>
              </Text>
              <Text
                className="font-normal lg:mt-[5px] xl:mt-[7px] 2xl:mt-[8px] 3xl:mt-[9px] not-italic text-white_A700_b2 w-[auto]"
                variant="body3"
              >
                Ready Job Vacancy
              </Text>
            ...
            <Column className="items-center xl:ml-[106px] 2xl:ml-[120px] 3xl:ml-[144px] lg:ml-[85px] lg:my-[35px] xl:my-[44px] 2xl:my-[50px] 3xl:my-[60px] w-[13%]">
              ...
              <Text
                className="font-normal xl:ml-[11px] 2xl:ml-[12px] 3xl:ml-[15px] lg:ml-[8px] lg:mt-[5px] xl:mt-[7px] 2xl:mt-[8px] 3xl:mt-[9px] not-italic text-white_A700_b2 w-[auto]"
                variant="body3"
              >
                Job Seekers Active
              </Text>
            ...
            <Line className="bg-white_A700_4c h-[undefinedpx] xl:ml-[106px] 2xl:ml-[120px] 3xl:ml-[144px] lg:ml-[85px] w-[1px]" />
            <Column className="items-center xl:ml-[106px] 2xl:ml-[120px] 3xl:ml-[144px] lg:ml-[85px] lg:mr-[152px] xl:mr-[191px] 2xl:mr-[215px] 3xl:mr-[258px] lg:my-[35px] xl:my-[44px] 2xl:my-[50px] 3xl:my-[60px] w-[13%]">
              <Text
          ...
          <Column className="font-sora items-center justify-center lg:mt-[29px] xl:mt-[36px] 2xl:mt-[41px] 3xl:mt-[49px] w-[100%]">
            <Column className="items-center justify-start lg:mt-[34px] xl:mt-[42px] 2xl:mt-[48px] 3xl:mt-[57px] w-[42%]">
              <Text
                className="lg:leading-[46px] xl:leading-[57px] 2xl:leading-[65px] 3xl:leading-[78px] text-bluegray_900 text-center tracking-ls1 w-[100%]"
                as="h3"
                variant="h3"
              >
              ...
              <Text
                className="font-light leading-[180.00%] lg:mt-[11px] xl:mt-[14px] 2xl:mt-[16px] 3xl:mt-[19px] text-bluegray_901 text-center w-[100%]"
                variant="body3"
              >
            ...
            >
              <Column className="items-center justify-start w-[100%]">
                ...
                <Column className="items-center justify-start lg:mt-[22px] xl:mt-[28px] 2xl:mt-[32px] 3xl:mt-[38px] w-[100%]">
                  ...
                  <Text className="Theprocessof" variant="body4">
          ...
          <Column className="font-sora items-center justify-center lg:mt-[29px] xl:mt-[36px] 2xl:mt-[41px] 3xl:mt-[49px] w-[100%]">
            <Column className="items-center justify-start lg:mt-[34px] xl:mt-[42px] 2xl:mt-[48px] 3xl:mt-[57px] w-[45%]">
              <Text
                className="text-bluegray_900 tracking-ls1 w-[auto]"
                as="h3"
                variant="h3"
              >
              ...
              <Text
                className="font-light lg:leading-[23px] xl:leading-[29px] 2xl:leading-[33px] 3xl:leading-[39px] lg:mt-[11px] xl:mt-[14px] 2xl:mt-[16px] 3xl:mt-[19px] text-bluegray_901 text-center w-[100%]"
                variant="body3"
              >
            ...
            <Row className="bg-white_A700 border border-indigo_200 border-solid items-center justify-center lg:mt-[22px] xl:mt-[28px] 2xl:mt-[32px] 3xl:mt-[38px] rounded-radius80 w-[55%]">
              ...
              <Row className="items-center justify-center xl:ml-[10px] 2xl:ml-[12px] 3xl:ml-[14px] lg:ml-[8px] w-[38%]">
                <Text
                  className="font-normal lg:leading-[23px] xl:leading-[29px] 2xl:leading-[33px] 3xl:leading-[39px] not-italic text-bluegray_400 w-[68%]"
                  variant="body3"
                >
                  Category
                </Text>
              ...
              <Text
                className="font-normal lg:leading-[23px] xl:leading-[29px] 2xl:leading-[33px] 3xl:leading-[39px] xl:ml-[10px] 2xl:ml-[12px] 3xl:ml-[14px] lg:ml-[8px] not-italic text-bluegray_400 w-[26%]"
                variant="body3"
              >
                Location
              </Text>
            ...
            <Column className="items-center justify-start lg:mt-[22px] xl:mt-[28px] 2xl:mt-[32px] 3xl:mt-[38px] w-[71%]">
              <Text
                className="font-normal not-italic text-bluegray_901 w-[auto]"
                variant="body1"
              >
                Popular category:
              </Text>
          ...
          <Column className="bg-gray_100 font-sora items-center justify-center lg:mt-[29px] xl:mt-[36px] 2xl:mt-[41px] 3xl:mt-[49px] w-[100%]">
            <Row className="items-end justify-between lg:mt-[56px] xl:mt-[71px] 2xl:mt-[80px] 3xl:mt-[96px] w-[83%]">
              <Column className="justify-start w-[53%]">
                ...
                <Text
                  className="font-light lg:leading-[23px] xl:leading-[29px] 2xl:leading-[33px] 3xl:leading-[39px] lg:mt-[11px] xl:mt-[14px] 2xl:mt-[16px] 3xl:mt-[19px] text-bluegray_901 w-[100%]"
                  variant="body3"
                >
            ...
            <Grid className="lg:gap-[17px] xl:gap-[21px] 2xl:gap-[24px] 3xl:gap-[28px] grid grid-cols-3 lg:mt-[28px] xl:mt-[35px] 2xl:mt-[40px] 3xl:mt-[48px] w-[83%]">
              <Column className="bg-white_A700 justify-start rounded-radius20 shadow-bs w-[100%]">
                      ...
                      <Column className="font-poppins items-center lg:mt-[5px] xl:mt-[7px] 2xl:mt-[8px] 3xl:mt-[9px] w-[100%]">
                        <Row className="items-center justify-evenly w-[100%]">
                          <Img
                            ...
                            alt="MapPin"
                          />
                          <Text className="Frame36" variant="body4">
                            Washington, USA
                          </Text>
                        </Row>
                      </Column>
                ...
                <Text className="font-sora Group82" as="h4" variant="h4">
                  Senior UX Designer
                </Text>
                <Row className="font-poppins items-center lg:ml-[14px] xl:ml-[17px] 2xl:ml-[20px] 3xl:ml-[24px] lg:mt-[5px] xl:mt-[7px] 2xl:mt-[8px] 3xl:mt-[9px] w-[40%]">
                  <Row className="items-center w-[50%]">
                    ...
                    <Text className="label1" variant="body4">
                      Full Time
                    </Text>
                  </Row>
                ...
                <Column className="items-center lg:mb-[11px] xl:mb-[14px] 2xl:mb-[16px] 3xl:mb-[19px] lg:mt-[14px] xl:mt-[17px] 2xl:mt-[20px] 3xl:mt-[24px] w-[100%]">
                  <Row className="items-center justify-between w-[90%]">
                    <Text
                      className="font-ubuntu text-gray_301 w-[auto]"
                      as="h6"
                      variant="h6"
                    >
              ...
              <Column className="bg-white_A700 justify-start rounded-radius20 shadow-bs w-[100%]">
                ...
                <Text className="Group82" as="h4" variant="h4">
                  Java Programmer
                </Text>
                <Row className="font-poppins items-center lg:ml-[14px] xl:ml-[17px] 2xl:ml-[20px] 3xl:ml-[24px] lg:mt-[5px] xl:mt-[7px] 2xl:mt-[8px] 3xl:mt-[9px] w-[40%]">
                  <Row className="items-center w-[50%]">
        ...
        <Column className="font-sora items-end xl:mt-[107px] 2xl:mt-[121px] 3xl:mt-[145px] lg:mt-[86px] w-[100%]">
          <Row className="bg-gradient  items-center justify-end lg:ml-[56px] xl:ml-[71px] 2xl:ml-[80px] 3xl:ml-[96px] mr-[2px] rounded-bl-[400px] rounded-br-[0] rounded-tl-[400px] rounded-tr-[0] w-[94%]">
            <Img
              ...
              alt="Photo"
            />
            <Column className="lg:ml-[36px] xl:ml-[46px] 2xl:ml-[52px] 3xl:ml-[62px] xl:mr-[120px] 2xl:mr-[136px] 3xl:mr-[163px] lg:mr-[96px] lg:my-[45px] xl:my-[56px] 2xl:my-[64px] 3xl:my-[76px] w-[38%]">
              <Column className="items-center w-[100%]">
                <Column className="justify-start w-[100%]">
                  <Text
                    className="font-sora lg:leading-[46px] xl:leading-[57px] 2xl:leading-[65px] 3xl:leading-[78px] text-white_A700 tracking-ls1 w-[100%]"
                    as="h3"
                    variant="h3"
                  >
                  ...
                  <Text
                    className="font-light font-opensans leading-[180.00%] lg:mt-[11px] xl:mt-[14px] 2xl:mt-[16px] 3xl:mt-[19px] text-white_A700 w-[100%]"
                    variant="body3"
                  >
                ...
                <Column className="justify-start lg:mt-[17px] xl:mt-[21px] 2xl:mt-[24px] 3xl:mt-[28px] w-[100%]">
                  <Column className="items-center w-[100%]">
                    <Column className="justify-start w-[100%]">
                      ...
                      <Text className="Productivethin" variant="body1">
                        Productive things you can do while waiting for the
                        results...
                      </Text>
                    </Column>
                  </Column>
                  <Text className="Title2" variant="body3">
                    Read more
                  </Text>
                </Column>
              </Column>
            ...
            <Column className="bg-bluegray_902 items-center justify-end w-[100%]">
              <Row className="items-start justify-between lg:mt-[45px] xl:mt-[56px] 2xl:mt-[64px] 3xl:mt-[76px] w-[83%]">
                <Row className="items-center justify-between w-[48%]">
                  <Column className="rotate-[180deg] w-[20%]">
                    <Text className="Menu1" variant="body3">
                      Services
                    </Text>
                    <Column className="items-center lg:mt-[17px] xl:mt-[21px] 2xl:mt-[24px] 3xl:mt-[28px] w-[100%]">
                      <Column className="justify-start w-[100%]">
                        <Text className="Frame49" variant="body4">
                          Jobs Vacancy
                        </Text>
                        <Text className="Shop" variant="body4">
                          Mentoring
                        </Text>
                        <Text className="Shop" variant="body4">
                          Our Community
                ...
                <Column className="justify-start lg:mr-[56px] xl:mr-[71px] 2xl:mr-[80px] 3xl:mr-[96px] w-[32%]">
                  ...
                  <Column className="justify-start lg:mt-[28px] xl:mt-[35px] 2xl:mt-[40px] 3xl:mt-[48px] w-[82%]">
                    ...
                    <Column className="items-center lg:mt-[17px] xl:mt-[21px] 2xl:mt-[24px] 3xl:mt-[28px] w-[100%]">
                      <Row className="items-center justify-between w-[100%]">
                        <Text
                          className="font-light text-gray_301 w-[auto]"
                          variant="body4"
                        >
                          (021) 876 567 986
                        </Text>
              ...
              <Row className="items-center justify-between lg:mb-[28px] xl:mb-[35px] 2xl:mb-[40px] 3xl:mb-[48px] lg:mt-[22px] xl:mt-[28px] 2xl:mt-[32px] 3xl:mt-[38px] w-[83%]">
                <Row className="items-start w-[9%]">
                  ...
                  />
                  <Text
                    className="font-bold lg:ml-[4px] xl:ml-[5px] 2xl:ml-[6px] 3xl:ml-[7px] text-white_A700_99 w-[auto]"
                    variant="body1"
                  >
                    Jbs.me
                  </Text>
                ...
                <Text
                  className="font-normal not-italic text-white_A700_99 w-[auto]"
                  variant="body4"
                >
